...
[![Testes Automatizados](https://img.shields.io/badge/Testes-249%20passando-brightgreen?style=flat-square&logo=pytest&logoColor=white)](https://github.com/Lucas2Araujo/NHA_Intel/actions/workflows/ci.yml)
...
| **Testes** | `pytest` & `pytest-asyncio` | 249 testes unitários e de integração com banco em memória (`:memory:`) |
...
O projeto conta com **249 testes assíncronos** cobrindo repositórios, serviços, views, comparador de versões, persistência e integridade do banco:
```bash
pytest -v
```
...
1. **Integração Contínua (CI - `.github/workflows/ci.yml`)**:
   ...
   - Executa a suíte completa de 249 testes unitários e de integração no ambiente Linux com Python 3.14.
